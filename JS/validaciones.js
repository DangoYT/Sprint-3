...
function validacion() {
  const nombreInput = document.getElementById("input_nombre");
  const nombreValue = nombreInput.value.trim();
  const nombreError = document.getElementById("nombreError");

  const tarjetaInput = document.getElementById("input_numeroTarjeta");
  ...
  const input_cvcValue = input_cvc.value.trim();
  const input_cvcError = document.getElementById("spanCvcError");
